...
PREDICT_INSTRUCTION = """You are given a list of chronological facts spanning multiple days about {ticker}. Your task is to assess the overall impact of these facts on the stock price and provide:
...
# , the contents of the example are not used to deduce the answer
PREDICT_REFLECT_INSTRUCTION = """You are given a list of chronological facts spanning multiple days about {ticker}. Your task is to assess the overall impact of these facts on the stock price and provide:
(1) One price Movement: either Positive or Negative no other responses are allowed.  
(2) One explanation: a short, single-paragraph justification summarizing the main reasons behind your prediction.
Do not output anything other than these two parts.
Here is a examples, the contents of the example are not used to deduce the answer:
